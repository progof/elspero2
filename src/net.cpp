...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Elspero " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"elsperotools.com", "46.101.13.106"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"elsperotools.com", "testnet-seed.elsperotools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Elspero is probably already running."), addrBind.ToString().c_str());
        else
